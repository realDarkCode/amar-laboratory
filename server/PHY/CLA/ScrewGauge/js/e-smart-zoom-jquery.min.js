  ...
  e.fn.smartZoom = function (t) {
    ...
    function m() {
      ...
      if (e.transitionObject) {
        ...
        if (e.transitionObject.css3dSupported) {
          i[e.transitionObject.transform] =
            "translate3d(" +
            r.x +
            "px, " +
            r.y +
    ...
    function w(e, t, r, i, s, o, u) {
      ...
      if (a.transitionObject != null) {
        ...
        if (a.transitionObject.css3dSupported)
          p[a.transitionObject.transform] =
            "translate3d(" +
            l +
            "px, " +
            c +
        ...
        e.animate(
          { "margin-left": l, "margin-top": c, width: i, height: s },
          {
            duration: o,
    ...
    var r = {
      init: function (t) {
        ...
        var o = e(
          '<div id="' + r + '" class="' + settings.containerClass + '"></div>"'
        );
        n.before(o);
        n.remove();
        o = e("#" + r);
        if (settings.containerClass == "")
          o.css({ "background-color": settings.containerBackground });
        o.append(n);
        var f = new Object();
    ...
    if (r[t]) {
      ...
      if (n[0].tagName.toLowerCase() == "img" && !n[0].complete) {
        n.bind("load.smartZoom", { arguments: arguments[0] }, y);
      } else {
