...
window.onload = function () {
  ...
  optionLabel = [
    ...
    gt.gettext("তার"),
    gt.gettext("কাচ দন্ড"),
    gt.gettext("Irregular lamina"),
    gt.gettext("তারের দৈর্ঘ = ৫ সেমি"),
    gt.gettext("LC = ০.০১ মিমি"),
    gt.gettext("LC = ০.০০5 মিমি"),
    gt.gettext("ফলাফল "),
  ];
  controlLabel = [
    gt.gettext("পুনঃস্থাপন"),
    gt.gettext("কার্যদর্শন"),
    gt.gettext("আবরন মুছে ফেলা"),
    gt.gettext("পুরত্ব নির্ণয়"),
  ];
  instructions = [
    gt.gettext("প্রথমে যান্ত্রিক ত্রুটি নির্ণয় করতে হবে"),
    gt.gettext("বস্তু নির্বাচন করে সেটি স্ক্র গজের সাহায্যে পরিমাপ করতে হবে"),
    gt.gettext("স্ক্র গজ নির্বাচন : "),
    gt.gettext("বস্তু নির্বাচন: "),
    gt.gettext("পরিমাপকৃত সংখ্যা প্রবেশ করান(মিমি): "),
    gt.gettext("Area of Lamina(mm<sup>2</sup>): "),
    gt.gettext("সংখ্যাটি প্রবেশ করান."),
    gt.gettext("আপনার উত্তরটি সঠিক হয়েছে."),
    gt.gettext("ভুল উত্তর, পুনঃরায় চেষ্টা করুন!"),
  ];
  imgarr = [
    "sphere.png",
    "wire.png",
  ...
  vscaletop1 = [14.09, 11.9, 12.8, 5.26];
  zoomCsscale1 = [624, 493, 545, 734];
  csr1 = [63, 83, 75, 46];
  vscales1 = [14.35, 11.45, 13.05, 5.8];
  ...
  vscaletop2 = [12.5, 8.6, 16.25, 7.56];
  zoomleftscale2 = [39, 57, 57, 72];
  zoomCsscale2 = [480, 212, 617, 127];
  msr2 = [1, 2, 2, 3];
  csr2 = [85, 26, 64, 39];
  vscales2 = [13.4, 6.9, 15.7, 11.15];
  ...
  $(document).ready(function () {
    ...
    function changeCombo2(elemid) {
      //lead shot, Wire, Glass palate, Irregular Lamina
    ...
    function shuffle() {
      cmn.randomNumbers =
        optNumber[Math.floor(Math.random() * optNumber.length)];
      //leadshot
      $("#default0").css({
        width: optWidth[cmn.randomNumbers] + "px",
        height: optHeight[cmn.randomNumbers] + "px",
    ...
    function answer_check() {
      ...
      if (textval == "") {
        ...
        ((Math.round(textval * 100) / 100).toFixed(3) == cmn.tsr &&
          cmn.flag1 == 1) ||
        (textval >= 760 && textval <= 770 && cmn.flag1 == 0)
      ) {
    ...
    function combo1() {
      //up arrow function for combo 1 value
        ...
        if ($("#smallimg").is(":visible")) {
          ...
          if (cmn.test >= cmn.test3) {
            ...
            if ($("#dup").attr("src") == simPath + "images/" + imgarr[0]) {
              ...
              $("#vscalebase").css(
                "top",
                "-=" + bgTop + vscaletop[cmn.randomNumbers] + "px"
              );
              //calculation part
              ...
              $("#dup").attr("src") ==
              simPath + "images/" + imgarr[1]
            ) {
              //wire
              $("#vscalebase").css(
                "top",
                "-=" + bgTop + vscaletop1[cmn.randomNumbers] + "px"
              );
              //calculation part
              cmn.msr = 0;
              ...
              $("#dup").attr("src") ==
              simPath + "images/" + imgarr[4]
            ) {
              //glass plate
              $("#vscalebase").css(
                "top",
                "-=" + bgTop + vscaletop2[cmn.randomNumbers] + "px"
              );
              //calculation part
    ...
    function combo2val() {
      //up arrow function for combo 2 value
      if (flag2 === true) {
        //image not visible
        if (!$("#smallimg").is(":visible")) {
          //up arrow
          if (cmn.test > cmn.test1) {
            $("#innerSCL").css("left", "-=" + bgLeft + 5.2 + "px");
            $("#holder").css("left", "-=" + bgLeft + 4.5 + "px");
            $("#vscalebase").css("top", "-=" + bgTop + 10.5 + "px");
          }
          if (cmn.test - 5.7 <= cmn.test1) {
            //zoom portion
            $("#msblck1").css("left", bgLeft + 34 + "px");
        ...
        if ($("#smallimg").is(":visible")) {
          ...
          if (cmn.test >= cmn.test3) {
            ...
            if ($("#dup").attr("src") == simPath + "images/" + imgarr[0]) {
              ...
              $("#vscalebase").css(
                "top",
                "-=" + bgTop + vscales[cmn.randomNumbers] + "px"
              );
              //calculation part
              ...
              correctedCsr = cmn.csr - cmn.zerocrr;
              cmn.tsr = (
                Math.round((cmn.msr + correctedCsr * cmn.lc1) * 100) / 100
              ).toFixed(3);
              $("#msblck1").css({
              ...
              $("#vscalebase").css(
                "top",
                "-=" + bgTop + vscales1[cmn.randomNumbers] + "px"
              );
              //calculation part
              cmn.msr = 0;
              ...
              $("#vscalebase").css(
                "top",
                "-=" + bgTop + vscales2[cmn.randomNumbers] + "px"
              );
              //calculation part
              ...
              //irregular lamina
              $("#vscalebase").css("top", "-=" + bgTop + 14.5 + "px");
              //calculation part
              cmn.msr = 1.5;
              cmn.csr = 83;
              cmn.zerocrr = 3;
    ...
    $("#arrows1").click(function () {
      ...
      $("#read").css("opacity", "0.5");
      cmn.rightoffset =
        $("#innerSCL").offset().left + $("#innerSCL").outerWidth();
    ...
    $(".picker").on("click", function () {
      ...
      //lamina
        ...
        if ($("#graphpage").css("display") == displayArray[0]) {
          //display of graph
          if (flag) {
            ...
            //disabling dropdown and image slector
            $(".picker").attr("disabled", true);
            $(".dropBox").prop("disabled", true);
          }
          $("#l1").click(function () {
            //remove lamina button
            //
        ...
        if ($("#mainimage").css("visibility") == "visible") {
          //main screw guage page
    ...
    $("#outerdiv").mouseenter(function () {
      $("#outerdiv").mousemove(function () {
        if (
          ...
          $("#plussign").data("clicked") == true &&
          $("#plussign").css("opacity") == 0.5
        ) {
