...
window.onload = function () {
  ...
  optionLabel = [
    gt.gettext("Lead shot"),
    gt.gettext("Wire"),
    gt.gettext("Glass plate"),
    gt.gettext("Irregular lamina"),
    gt.gettext("Wire length = 5 cm"),
    gt.gettext("LC = 0.01 mm"),
    gt.gettext("LC = 0.005 mm"),
    gt.gettext("Result "),
  ];
  controlLabel = [
    gt.gettext("Reset"),
    gt.gettext("Check"),
    gt.gettext("Remove Lamina"),
    gt.gettext("Find thickness"),
  ];
  instructions = [
    gt.gettext("Check for zero error."),
    gt.gettext(
      "Click on the object to find its measurement and click it once more to remove it."
    ),
    gt.gettext("Select screw guage : "),
    gt.gettext("Select an object : "),
    gt.gettext("Enter the reading(mm): "),
    gt.gettext("Area of Lamina(mm<sup>2</sup>): "),
    gt.gettext("Input Box is empty."),
    gt.gettext("Good! Answer is correct."),
